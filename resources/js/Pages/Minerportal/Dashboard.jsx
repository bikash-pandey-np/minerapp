        ...
        <Layout>
            ...
            >
                ...
                <motion.div className="mb-8" variants={itemVariants} style={{ willChange: 'transform' }}>
                    ...
                    <div className="stat bg-base-100 shadow-xl rounded-lg w-full md:w-1/2 lg:w-1/3 hover:shadow-2xl transition-shadow duration-300">
                ...
                <motion.div className="mb-8" variants={itemVariants} style={{ willChange: 'transform' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="stat bg-base-100 shadow-xl rounded-lg hover:shadow-2xl transition-shadow duration-300">
                            <div className="stat-figure text-primary">
                ...
                <motion.div variants={itemVariants} style={{ willChange: 'transform' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <motion.div 
                            className="stat bg-base-100 shadow-xl rounded-lg hover:shadow-2xl transition-shadow duration-300"
